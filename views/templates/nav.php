    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
              ...
              -->
                        <div x-show="open" x-transition:enter="transition ease-linear duration-500"
                             ...
                             x-transition:leave-end="opacity-0 transform scale-75" @click.away="open = false"
                             class="absolute right-0 z-10 mt-4 w-60 origin-top-right rounded-md bg-gray-800 py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                            ...
                            <div class="flex items-center px-1">
                                ...
                                <div class="ml-3 py-5 mr-5">
                                    <div class="text-base mb-1 font-medium leading-none text-white">Tom Cook</div>
