    ...
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        <form method="post" class="was-validated">
                        ...
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-2">
                                <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                    <input value= "<?= $_POST['title'] ?? '' ?>" style="color: #043749; font-size: small; font-family: cursive;" type="text" name="title" id="title" class="block flex-1 border-0 bg-transparent py-1.5
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
                <button name="cancel" type="reset" class=" rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Cancel</button>
